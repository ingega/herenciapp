...
A production-grade web application for restaurant management and control, specifically designed for **Herencia del Abuelo**. This project leverages a modern FastAPI backend with a responsive Bootstrap frontend.
