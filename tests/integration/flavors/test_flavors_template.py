...
# ==============================================================================
def test_flavors_page_unauthenticated_redirects(client):
    """
    ...
    response = client.get("/orders/flavors/list", follow_redirects=False)
...
# ==============================================================================
def test_flavors_page_authenticated_success(client, authorized_client_cookies):
    """
    ...
    # Assert 1: Verify it stayed on the flavors page (No redirection triggered!)
